...
WaClient.on('message', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(msg) {
    var data, button, quotedMsg, _button, _quotedMsg, _button2;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          button = new Buttons('Silahkan pilih menu :', [{
            body: 'Genba Angin'
          }, {
            body: 'Genba Maintenance'
          }], "Hello ".concat(msg.rawData.notifyName));
          WaClient.sendMessage(msg.from, button);
          _context.next = 29;
          break;
        case 5:
          if (!(msg.body === 'Genba Angin')) {
            _context.next = 18;
            break;
          }
        ...
        case 9:
          quotedMsg = _context.sent;
          if (!quotedMsg.fromMe) {
            _context.next = 13;
            break;
          }
          _context.next = 13;
          return quotedMsg["delete"](true);
        case 13:
          _button = new Buttons('Silahkan pilih plant menu :', [{
            body: 'GM1'
          }, {
            body: 'GM2'
          }], "Hello ".concat(msg.rawData.notifyName));
          _context.next = 16;
          return WaClient.sendMessage(msg.from, _button);
        case 16:
          _context.next = 29;
          break;
        case 18:
          if (!(msg.body === 'Genba Maintenance')) {
            _context.next = 29;
            break;
          }
          if (!(msg.rawData.type === 'buttons_response' && msg.hasQuotedMsg)) {
          ...
          return msg.getQuotedMessage();
        case 22:
          _quotedMsg = _context.sent;
          if (!_quotedMsg.fromMe) {
            _context.next = 26;
            break;
          }
          _context.next = 26;
          return _quotedMsg["delete"](true);
        case 26:
          _button2 = new Buttons('Silahkan pilih plant menu :', [{
            body: 'GM1'
          }, {
            body: 'GM2'
          }], "Hello ".concat(msg.rawData.notifyName));
          _context.next = 29;
          return WaClient.sendMessage(msg.from, _button2);
        case 29:
        case "end":
...
function sendMenu1(msg) {
  var button = new Buttons('Silahkan pilih menu :', [{
    body: 'Genba Angin'
  }, {
    body: 'Genba Maintenance'
  }], "Hello ".concat(msg.notifyName));
  WaClient.sendMessage(msg.from, button);
}
function sendMenu2(msg) {
  var button = new Buttons('Silahkan pilih plant menu :', [{
    body: 'GM1'
  }, {
    body: 'GM2'
  }], "Hello ".concat(msg.notifyName));
